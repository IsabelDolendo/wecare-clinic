    ...
    >
      ...
      <aside className="hidden md:flex bg-brand-red text-white p-4 flex-col gap-3">
        ...
        <nav className="flex-1 space-y-1">
          <Link href="/dashboard/patient" className="block px-3 py-2 rounded hover:bg-brand-red-light/30">
            <span className={collapsed ? "hidden" : "inline"}>Main Dashboard</span>
          </Link>
          <Link href="/dashboard/patient/appointments" className="block px-3 py-2 rounded hover:bg-brand-red-light/30">
            <span className={collapsed ? "hidden" : "inline"}>Appointment Booking</span>
          </Link>
          <Link href="/dashboard/patient/history" className="block px-3 py-2 rounded hover:bg-brand-red-light/30">
            <span className={collapsed ? "hidden" : "inline"}>History of Booking</span>
          </Link>
          <Link href="/dashboard/patient/e-vaccination-card" className="block px-3 py-2 rounded hover:bg-brand-red-light/30">
            <span className={collapsed ? "hidden" : "inline"}>E-Vaccination Card</span>
          </Link>
          <Link href="/dashboard/patient/profile" className="block px-3 py-2 rounded hover:bg-brand-red-light/30">
            <span className={collapsed ? "hidden" : "inline"}>Profile Management</span>
          </Link>
          <Link href="/dashboard/patient/about" className="block px-3 py-2 rounded hover:bg-brand-red-light/30">
            <span className={collapsed ? "hidden" : "inline"}>About WeCare Clinic</span>
          </Link>
          <Link href="/dashboard/patient/messages" className="block px-3 py-2 rounded hover:bg-brand-red-light/30">
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <aside className="relative z-10 bg-brand-red text-white w-64 h-full p-4 flex flex-col gap-3">
            ...
            <nav className="flex-1 space-y-1">
              ...
              <Link href="/dashboard/patient/history" className="block px-3 py-2 rounded hover:bg-white/10" onClick={() => setDrawerOpen(false)}>
                History of Booking
              </Link>
              <Link href="/dashboard/patient/e-vaccination-card" className="block px-3 py-2 rounded hover:bg-white/10" onClick={() => setDrawerOpen(false)}>
                E-Vaccination Card
              </Link>
              <Link href="/dashboard/patient/profile" className="block px-3 py-2 rounded hover:bg-white/10" onClick={() => setDrawerOpen(false)}>
                Profile Management
              </Link>
              <Link href="/dashboard/patient/about" className="block px-3 py-2 rounded hover:bg-white/10" onClick={() => setDrawerOpen(false)}>
                About WeCare Clinic
              </Link>
              <Link href="/dashboard/patient/messages" className="block px-3 py-2 rounded hover:bg-white/10" onClick={() => setDrawerOpen(false)}>
                Messages
              </Link>
            </nav>
            <LogoutButton />
